...
namespace Ts3era.Migrations
{
    ...
    [Migration("20240521114322_editcomplaintattachment")]
    partial class editcomplaintattachment
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Ts3era.Models.FeedBack", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Ts3era.Models.PortTypes", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Ts3era.Models.Ports", b =>
                {
                    ...
                    b.HasIndex("PortType_Id");

                    b.ToTable("Ports");
                });

            modelBuilder.Entity("Ts3era.Models.Product", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<float>("Price_From")
                        .HasColumnType("real");

                    b.Property<float>("Price_TO")
                        .HasColumnType("real");
            ...
            modelBuilder.Entity("Ts3era.Models.SubCategory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Ts3era.Models.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Ts3era.Models.ApplicationUser", b =>
                {
                    b.OwnsMany("Ts3era.Models.RefreshToken", "RefreshTokens", b1 =>
                        {
                            ...
                            b1.Property<DateTime?>("RenokedOn")
                                .HasColumnType("datetime2");
            ...
            modelBuilder.Entity("Ts3era.Models.Ports", b =>
                {
                    ...
                    b.HasOne("Ts3era.Models.PortTypes", "PortTypes")
                        .WithMany()
                        .HasForeignKey("PortType_Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("Governorates");

                    b.Navigation("PortTypes");
                });

            modelBuilder.Entity("Ts3era.Models.Product", b =>
                {
                    b.HasOne("Ts3era.Models.SubCategory", "SubCategory")
                        .WithMany("Products")
            ...
            modelBuilder.Entity("Ts3era.Models.SubCategory", b =>
                {
                    b.HasOne("Ts3era.Models.Category", "Category")
